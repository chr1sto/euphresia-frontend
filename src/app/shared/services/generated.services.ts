...
export class FileUploadService {
     ...
     * @return Success
     */
    fileUploadDelete(id: string): Observable<ApiResultOfString> {
        ...
        return this.http.request("delete", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processFileUploadDelete(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processFileUploadDelete(<any>response_);
                } catch (e) {
                    return <Observable<ApiResultOfString>><any>_observableThrow(e);
                }
            } else
    ...
    protected processFileUploadDelete(response: HttpResponseBase): Observable<ApiResultOfString> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class NewsService {
     ...
     * @return Success
     */
    newsGet(): Observable<NewsPostViewModel[]> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<NewsPostViewModel[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<NewsPostViewModel[]>><any>_observableThrow(response_);
        }));
    }

    protected processNewsGet(response: HttpResponseBase): Observable<NewsPostViewModel[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            if (resultData200 && resultData200.constructor === Array) {
                ...
                for (let item of resultData200)
                    result200!.push(NewsPostViewModel.fromJS(item));
            }
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
        ...
        return _observableOf<NewsPostViewModel[]>(<any>null);
    }
     ...
     * @return Success
     */
    newsPost(newsViewModel: NewsPostViewModel | null | undefined): Observable<NewsPostViewModel[]> {
        let url_ = this.baseUrl + "/api/v1/news";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processNewsPost(response: HttpResponseBase): Observable<NewsPostViewModel[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            if (resultData400 && resultData400.constructor === Array) {
                ...
                for (let item of resultData400)
                    result400!.push(NewsPostViewModel.fromJS(item));
            }
            return throwException("A server error occurred.", status, _responseText, _headers, result400);
            }));
        } else if (status !== 200 && status !== 204) {
     ...
     * @return Success
     */
    newsDelete(id: string | null | undefined): Observable<NewsPostViewModel[]> {
        let url_ = this.baseUrl + "/api/v1/news?";
        if (id !== undefined)
    ...
    protected processNewsDelete(response: HttpResponseBase): Observable<NewsPostViewModel[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    newsPatch(newsViewModel: NewsPostViewModel | null | undefined): Observable<NewsPostViewModel[]> {
        let url_ = this.baseUrl + "/api/v1/news";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processNewsPatch(response: HttpResponseBase): Observable<NewsPostViewModel[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
